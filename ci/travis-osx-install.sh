...
# Currently homebrew fails to link python2, as there is other version installed.
# Unsure why the conflict arises, we will let it do it's best and ignore the rest.
brew link --force $QT_PKG || true
